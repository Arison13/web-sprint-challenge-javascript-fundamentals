...
//nested function can access the variable internal because of closure. it can reach to that parent function and grab the data it needs to run, but the parent(myFunction) function cannot reach the data inside the nested function.
